...
#include <stdint.h>
#include <stdbool.h>
typedef struct __swift_bridge__$ConnKeyBridge { void* user; void* hostname; uint16_t port; void* config_hash_hex; } __swift_bridge__$ConnKeyBridge;
typedef struct __swift_bridge__$Option$ConnKeyBridge { bool is_some; __swift_bridge__$ConnKeyBridge val; } __swift_bridge__$Option$ConnKeyBridge;
typedef struct __swift_bridge__$FileEntryBridge { void* name; bool is_dir; uint64_t size; int64_t mtime; uint32_t mode; } __swift_bridge__$FileEntryBridge;
...
void* __swift_bridge__$Vec_SftpListingBridge$new(void);
void __swift_bridge__$Vec_SftpListingBridge$drop(void* vec_ptr);
void __swift_bridge__$Vec_SftpListingBridge$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_SftpListingBridge$pop(void* vec_ptr);
void* __swift_bridge__$Vec_SftpListingBridge$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_SftpListingBridge$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_SftpListingBridge$len(void* vec_ptr);
void* __swift_bridge__$Vec_SftpListingBridge$as_ptr(void* vec_ptr);

typedef struct CancelFlagBridge CancelFlagBridge;
void __swift_bridge__$CancelFlagBridge$_free(void* self);

void* __swift_bridge__$Vec_CancelFlagBridge$new(void);
void __swift_bridge__$Vec_CancelFlagBridge$drop(void* vec_ptr);
void __swift_bridge__$Vec_CancelFlagBridge$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_CancelFlagBridge$pop(void* vec_ptr);
void* __swift_bridge__$Vec_CancelFlagBridge$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_CancelFlagBridge$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_CancelFlagBridge$len(void* vec_ptr);
void* __swift_bridge__$Vec_CancelFlagBridge$as_ptr(void* vec_ptr);

typedef struct SftpHandleBridge SftpHandleBridge;
void __swift_bridge__$SftpHandleBridge$_free(void* self);

void* __swift_bridge__$Vec_SftpHandleBridge$new(void);
void __swift_bridge__$Vec_SftpHandleBridge$drop(void* vec_ptr);
void __swift_bridge__$Vec_SftpHandleBridge$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_SftpHandleBridge$pop(void* vec_ptr);
void* __swift_bridge__$Vec_SftpHandleBridge$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_SftpHandleBridge$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_SftpHandleBridge$len(void* vec_ptr);
void* __swift_bridge__$Vec_SftpHandleBridge$as_ptr(void* vec_ptr);

typedef struct SshPoolBridge SshPoolBridge;
void __swift_bridge__$SshPoolBridge$_free(void* self);

void* __swift_bridge__$Vec_SshPoolBridge$new(void);
void __swift_bridge__$Vec_SshPoolBridge$drop(void* vec_ptr);
void __swift_bridge__$Vec_SshPoolBridge$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_SshPoolBridge$pop(void* vec_ptr);
void* __swift_bridge__$Vec_SshPoolBridge$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_SshPoolBridge$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_SshPoolBridge$len(void* vec_ptr);
void* __swift_bridge__$Vec_SshPoolBridge$as_ptr(void* vec_ptr);

void* __swift_bridge__$ssh_pool_new(void);
void* __swift_bridge__$ssh_pool_list_configured_hosts(void);
struct __swift_bridge__$ResultConnKeyBridgeAndString __swift_bridge__$ssh_pool_connect(void* pool, struct __swift_bridge__$ConnectSpecBridge spec, void* hostkey_cb, void* passphrase_cb, void* password_cb);
...
void* __swift_bridge__$sftp_unlink(void* h, void* path);
struct __private__ResultPtrAndPtr __swift_bridge__$sftp_read_head(void* h, void* path, uint32_t max);
void* __swift_bridge__$cancel_flag_new(void);
void __swift_bridge__$cancel_flag_cancel(void* f);
...
typedef enum __swift_bridge__$ResultFileStatBridgeAndString$Tag {__swift_bridge__$ResultFileStatBridgeAndString$ResultOk, __swift_bridge__$ResultFileStatBridgeAndString$ResultErr} __swift_bridge__$ResultFileStatBridgeAndString$Tag;
union __swift_bridge__$ResultFileStatBridgeAndString$Fields {struct __swift_bridge__$FileStatBridge ok; void* err;};
typedef struct __swift_bridge__$ResultFileStatBridgeAndString{__swift_bridge__$ResultFileStatBridgeAndString$Tag tag; union __swift_bridge__$ResultFileStatBridgeAndString$Fields payload;} __swift_bridge__$ResultFileStatBridgeAndString;
